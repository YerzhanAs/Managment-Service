package com.example.video_task_8_16.controllers;
...
public class HomeController {
    ...
    public String addItem(@RequestParam(name="country_id", defaultValue = "No Item") Long id,
